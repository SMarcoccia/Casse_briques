...
// Note : dernière version de mingw 64 bit n'accepte pas le caste de gAnm_Itm1 et des autres ; 
// on doit casté avec : intptr_t et remplacé u32 par celui-ci.
