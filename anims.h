...
enum{
  ...
  e_Anm_Goto = BIT31 | 2, // Initialise une autre anime.
  e_Anm_End = BIT31 | 3, // Fin d'une anim. Renvoie SPR_NoSprite, place e_AnmFlag_End, libère pas le slots.
...
extern u32	gAnm_MstExplo1NoSound[];
